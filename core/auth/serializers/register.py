...
class RegisterSerializer(UserSerializers):
    """Registration serializers for  request and user creation"""
    # making sure the password is at least 8 characters long and no longer than 128 and can't be read by user
